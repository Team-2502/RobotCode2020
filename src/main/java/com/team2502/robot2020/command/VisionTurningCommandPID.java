...
public class VisionTurningCommandPID extends PIDCommand {
    ...
    private final NetworkTableEntry KpEntry = shuffleboard.add("PID: Kp", 0D).getEntry();
    private final NetworkTableEntry KiEntry = shuffleboard.add("PID: Ki", 0D).getEntry();
    private final NetworkTableEntry KdEntry = shuffleboard.add("PID: Kd", 0D).getEntry();
